...
module.exports = {
  v2SuffixTemplatesDeprecated(template, name) {
    ...
    console.log(chalk.red('  This template is deprecated, as the original template now uses Vue2.0 by default.'))
    console.log()
  ...
  v2BranchIsNowDefault(template, name) {
    ...
    console.log(chalk.green('  This will install Vue2.x version of the template.'))
    console.log()
    console.log(chalk.yellow('  For Vue1.x use: ') + chalk.green(vue1InitCommand))
    console.log()
  }
}
